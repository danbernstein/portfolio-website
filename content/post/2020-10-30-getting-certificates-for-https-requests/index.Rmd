...
![](/2020-10-30-getting-certificates-for-https-requests/index_files/Screenshot from 2020-10-30 15-36-47.png)
...
To get the certifcate chain (in Chrome):
1. Click on the lock icon next to the address bar.
2. Click "Certificates".
3. Click "Details".
4. Click "Export...".
5. Save the file to your local computer. Make sure you select "Base64-encoded ASCII, certificate chain" as the format. Otherwise you will not have the appropriate chain of certificates to make the request properly.
