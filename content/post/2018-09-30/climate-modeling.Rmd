---
title: "Forecasting: Climate Modeling"
author: Dan
date: '2018-09-30'
...
```{r load observational data in shapefile, eval=FALSE}
...
```{r resample observational data, eval=FALSE}
...
```{r bias correction plot, eval=FALSE}
...
```{r spatial disaggregation step 1, eval=FALSE}
...
```{r spatial disaggregation step 2, eval=FALSE}
...
```{r bias adjusted spatially disaggregated plot, eval=FALSE}
